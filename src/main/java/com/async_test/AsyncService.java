...
public class AsyncService {
    ...
    @Transactional
    public void saveUserNonAsync(String name, String email) {
        userRepository.save(
            UserEntity.builder()
                .name(name)
                .email(email)
    ...
    @Transactional
    public void saveNoteNonAsync(String name, String count){
        noteRepository.save(
            NoteEntity.builder()
                .name(name)
                .pageCount(count)
    ...
    @Async
    @Transactional
    public CompletableFuture<Void> saveUserTrueAsync(String name, String email) {
        userRepository.save(
                UserEntity.builder()
                        .name(name)
                        .email(email)
    ...
    @Async
    @Transactional
    public CompletableFuture<Void> saveNoteTrueAsync(String name, String count){
        noteRepository.save(
                NoteEntity.builder()
                        .name(name)
                        .pageCount(count)
